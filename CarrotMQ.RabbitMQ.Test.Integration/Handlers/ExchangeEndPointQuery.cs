...
public class ExchangeEndPointQuery : DtoBase, IQuery<ExchangeEndPointQuery, ExchangeEndPointQuery.Response, TestExchange>
{
    public ExchangeEndPointQuery(int id)
    {
        Id = id;
    }
    ...
    public class Response
    {
        ...
        {
            return $"{nameof(ExchangeEndPointQuery)}->Response()";
        }
    }
}