...
public class QueueEndPointCmd : DtoBase, ICommand<QueueEndPointCmd, QueueEndPointCmd.Response, TestQueue>
{
    public QueueEndPointCmd(int id)
    {
        Id = id;
    }
    ...
    public class Response
    {
        ...
        {
            return $"{nameof(QueueEndPointCmd)}->Response()";
        }
    }
}